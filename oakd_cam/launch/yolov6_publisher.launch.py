...
def generate_launch_description():
    oakd_cam_path = get_package_share_directory('oakd_cam')

    default_rviz = os.path.join(oakd_cam_path,
                                'rviz', 'pointCloud.rviz')
    urdf_launch_dir = os.path.join(get_package_share_directory('depthai_descriptions'), 'launch')
    default_resources_path = os.path.join(oakd_cam_path,
                                'resources')
    ...
    camera_param_uri   = LaunchConfiguration('camera_param_uri',  default = 'package://oakd_cam/params/camera')
